...
export default function ProductView({ shoe }: { shoe: any }) {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row pt-12 items-start px-4 md:px-0 md:gap-4 gap-8">
      <div className="w-full md:w-1/2 md:sticky md:top-12">
        <ShoeGallery images={currentColor?.img} />
      </div>
      <div className="w-full md:w-1/2 my-20 flex flex-col md:pr-90">
